...
public class BranchAPI {
	...
	public Response GET_responseURL(String url){
		...
		return given()
			.header("User-Agent", "Mozilla/5.0 (Linux; Android 9; SM-G960F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.157 Mobile Safari/537.36")
		.when()
			.get(config.getString("deepLink"));
	}
